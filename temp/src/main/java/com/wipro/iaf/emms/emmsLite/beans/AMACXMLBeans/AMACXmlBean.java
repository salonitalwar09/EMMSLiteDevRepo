...
public class AMACXmlBean {
	...
	private ArrayList<AssetBean> assetList;
	...
	public void setIafDettFLBPostFGTDataStatus(
	...
	public ArrayList<AssetBean> getAssetList() {
		return assetList;
	}

	public void setAssetList(ArrayList<AssetBean> assetList) {
	...
	public String toString() {
		return "AMACXmlBean [assetNum=" + assetNum + ", cMItem=" + cMItem
				...
				+ transferDate + ", variation=" + variation + ", assetList="
				+ assetList.toString() + ", personList="
				+ personList.toString() + "]";
	}
